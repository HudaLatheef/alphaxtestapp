...
abstract class _$$ExceedingminbalanceImplCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory _$$ExceedingminbalanceImplCopyWith(
    _$ExceedingminbalanceImpl<T> value,
...
class __$$ExceedingminbalanceImplCopyWithImpl<T, $Res>
  ...
  __$$ExceedingminbalanceImplCopyWithImpl(
    _$ExceedingminbalanceImpl<T> _value,
...
class _$ExceedingminbalanceImpl<T> implements Exceedingminbalance<T> {
  ...
  get copyWith =>
      __$$ExceedingminbalanceImplCopyWithImpl<T, _$ExceedingminbalanceImpl<T>>(
        this,
        _$identity,
      );
...
class __$$ExceedingLengthvalueImplCopyWithImpl<T, $Res>
  ...
  __$$ExceedingLengthvalueImplCopyWithImpl(
    _$ExceedingLengthvalueImpl<T> _value,
...
abstract class _$$ShortlengthImplCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory _$$ShortlengthImplCopyWith(
    _$ShortlengthImpl<T> value,
...
class __$$ShortlengthImplCopyWithImpl<T, $Res>
  ...
  __$$ShortlengthImplCopyWithImpl(
    _$ShortlengthImpl<T> _value,
    $Res Function(_$ShortlengthImpl<T>) _then,
  ) : super(_value, _then);
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? failedValue = freezed, Object? minLength = freezed}) {
    return _then(
      _$ShortlengthImpl<T>(
        failedValue: freezed == failedValue
            ? _value.failedValue
...
class _$ShortlengthImpl<T> implements Shortlength<T> {
  const _$ShortlengthImpl({this.failedValue, this.minLength});
...
abstract class Shortlength<T> implements ValueFailure<T> {
  const factory Shortlength({final T? failedValue, final int? minLength}) =
      _$ShortlengthImpl<T>;
...
abstract class _$$PassworddoesntmatchImplCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory _$$PassworddoesntmatchImplCopyWith(
    _$PassworddoesntmatchImpl<T> value,
...
class __$$PassworddoesntmatchImplCopyWithImpl<T, $Res>
  ...
  __$$PassworddoesntmatchImplCopyWithImpl(
    _$PassworddoesntmatchImpl<T> _value,
...
class _$PassworddoesntmatchImpl<T> implements Passworddoesntmatch<T> {
  ...
  get copyWith =>
      __$$PassworddoesntmatchImplCopyWithImpl<T, _$PassworddoesntmatchImpl<T>>(
        this,
        _$identity,
      );
