...
class Username extends ValueObject<String> {
  ...
  factory Username(String input) {
    return Username._(
      ...
      // validateMinLengthValue(input, 6),
    );
  }
...
class NewUsername extends ValueObject<String> {
  @override
  final Either<ValueFailure<String>, String> value;

  factory NewUsername(String input) {
    return NewUsername._(
      // validateStringNotEmpty(input),
      validateMinLengthValue(input, 6),
    );
  }

  const NewUsername._(this.value);
}
